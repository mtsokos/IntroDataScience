...
## 12. define a vector called 'names' by including all the names in a vector. Add a vector 'names' to 'myFriends' using cbind function.  
#Print the structure of 'myFriends'. What is the data type (among: factor, numeric, logical, string) of the 'names'? 
names <-c("John", "Smith", "Susan", "Joe", "Wendy")
myFriends <- cbind(myFriends, names)
str(myFriends)
#names data type is factor
